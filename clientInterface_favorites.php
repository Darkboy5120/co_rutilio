...
<html lang="en">
  <head>
    ...
    <title>TimeToFood | Favorites</title>
  </head>
  <body>
      ...
      <div class="row">
        <div class="col mt-3">
          <div class="card" style="width: 18rem;">
            <img src="assets/files/img/el-vaquero.jpg" class="card-img-top" alt="...">
            <div class="card-body">
              ...
              <div class="btn-group" role="group" aria-label="Basic example">
                <a href="clientInterface_tables.php" class="btn btn-primary">Get in</a>
                <button type="button" class="btn btn-secondary active">Unfavorite</button>
              </div>
            </div>
          </div>
        </div>

        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form id="mp-form">
              ...
              <div class="form-group">
                <label for="mp-description">Restaurant Description</label>
                <textarea class="form-control" id="mp-description" rows="3"
                  required></textarea>
              </div>
              <div class="form-group">
                <label for="mp-image">Restaurant image (optional)</label>

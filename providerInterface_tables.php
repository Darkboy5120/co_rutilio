...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="providerInterface_tables.php">Tables</a>
          </li>
          <li class="nav-item">
      ...
      <div class="form-group">
        <div class="input-group">
          <div class="input-group-prepend">
            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#ct">New table</button>
          </div>
              ...
              <div class="d-flex align-items-center justify-content-between">
                <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                  <div class="btn-group mr-2" role="group" aria-label="First group">
                    ...
                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#dt">
    ...
    <script src="assets/js/providerInterface_tables_modalTemplate.js"></script>
    <script src="assets/js/providerInterface_tables.js"></script>
  </body>
</html>